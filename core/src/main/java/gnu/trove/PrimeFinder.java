...
public final class PrimeFinder {
    ...
    static {
        ...
        Arrays.sort(primeCapacities0);

        primeCapacities = primeCapacities0;
    }
    ...
    public static int nextPrime(int desiredCapacity) {
        if (primeCapacities == null) throw NotAlreadyInitializedException.INSTANCE;
    ...
    public static final class NotAlreadyInitializedException extends RuntimeException {

        private static final long serialVersionUID = 1L;

        public static NotAlreadyInitializedException INSTANCE = new NotAlreadyInitializedException();

        private NotAlreadyInitializedException() {
            super("PrimeFinder is not already initialized.", null, false, false);
        }
